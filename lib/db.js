...
async function savePdfSummary({ original_file_url, summary_text, title, file_name }) {
  ...
  try {
    ...
    console.error("Error inserting user (maybe already exists):", err);
  }
  ...
  try {
    ...
    console.error("Error inserting PDF summary:", error);
    throw error;
  }
}
...
async function handleCheckoutSessionCompleted({ session }) {
  try {
    ...
    `;
    toast.success("✅ Plan updated, client should show toast and reload to see new plan.");
